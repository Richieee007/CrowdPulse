                  ...
                  className="filter-gray"   
                   />
                    ...
                    <Input type="number" placeholder="Price" {
                      ...
                      ...field} className="p-regular-16 border-0 bg-grey-50 outline-offset-0 
                      focus:bottom-0 focus-visible:ring-0 focus-visible:ring-offset-0" />
            ...
            <FormItem>
              <FormControl>
                <div className="flex items-center">
                  ...
                  pr-3 leading-none 
                  peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Free Tickets</Label>
                  <Checkbox
